/*
  ...
  The circuit:
  - Arduino Nano Ble33 board equipped with ECC508 or ECC608 chip

  This example code is in the public domain.
*/

#include "generate-csr.hpp"
...
void setupCSR()
{
  ...
  if (!ECCX08.locked())
  {
    String lock = promptAndReadLine(
        "The ECCX08 on your board is not locked, would you like to PERMANENTLY configure and lock it now? (y/N)", "N");
    lock.toLowerCase();
